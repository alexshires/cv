...
\item \textbf{Ph.D., High Energy Physics} , \textit{October 2013}
        \begin{compactitem}
        \item Thesis title: \href{https://cds.cern.ch/record/1607078?ln=en}{\emph{Exploring $b\rightarrow s$ electroweak penguins at LHCb}}
...
\item \textbf{MSci (Hons), {Physics with Theoretical Physics}}, \textit{October 2009}
        \begin{compactitem}
        \item First Class honours classification.
