...
My first project tested lepton universality, where I developed new models to describe the data,
...
%\cvitem{ 2014 }{ Particle identification seminar, part of the $4^{\text{th}}$ year particle detectors lecture course, \tud. }
%\cvitem{ 2012 }{ Computational lab demonstrator, $3^{\text{rd}}$ year undergradudate course, \icl. }
