...
\section{Education}
\cventry{Oct 2013}{PhD, High Energy Physics}{\icl}{}{}{
\href{https://cds.cern.ch/record/1607078?ln=en}{\emph{Exploring $b\rightarrow s$
...
requirement for the first two measurements of \BdToKstmm
...
\cventry{Jun 2009}{MSci (Hons), Physics With Theoretical Physics}{\icl}{}{\textit{}}
...
This four year course involved specific courses in applied mathematics, statistics
and computing dedicated to implementing algorithms for modelling and data analysis.}
\cventry{Aug 2005}{A-levels, GCSEs}{Hardenhuish School}{Chippenham, Wiltshire, UK}
...
\cventry{2013\\ to present}{Post doctoral researcher}{\tud}{}{}{
...
My first project tested lepton universality, where I developed new models,
implemented all the calculations in a coherent framework and brought the result to
publication.
Alongside this, I initiated a collaboration with the theory department to produce
supporting research.
I am currently extending previous measurements of \btosll decays and measuring
\btodll decays. \\
Detailed achievements:%
\begin{itemize}%
\item Delivered two high quality publications, one experimental and one theoretical
in the first year.
\item Subsequent placement at \cern for three months to contribute to the \lhcb
trigger system.
\item Supervised MSc and BSc students for their final undergraduate projects.
\end{itemize}}
%\cventry{year--year}{Job title}{Employer}{City}{}{Description line
%1\newline{}Description line 2}

\cventry{Summer\\ 2008}{Undergraduate research placement}{\icl}{}{}{Developed and
...
\cvitem{ 2014 }{ Project supervision, $4^{\text{th}}$ year undergraduate course, TU
Dortmund. }
\cvitem{ 2014 }{ Project supervision, $3^{\text{rd}}$ year undergraduate course, TU
Dortmund. }
\cvitem{ 2014 }{ Particle identification seminar, part of the $4^{\text{th}}$ year
particle detectors lecture course, TU Dortmund. }
