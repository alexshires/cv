...
from local Python scripts to production code in C++ used for data-taking.
The data-taking software is a critical requirement to record quality data and the output is used by the entire collaboration.
