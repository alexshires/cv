...
A highly-motivated researcher, I have five years’ experience of contributing to the
\lhcb collaboration at \cern whilst working at \icl and \tud.
My research was focussed on searching for physics beyond the standard model in \bsll
decays.\\


\cvitem{Key Skills}{Analytical problem solving, Statistics, Data Analysis, Programming}

\section{Employment history}
\cventry{2013\\ to present}{Post doctoral researcher}{\tud}{Germany}{}{
\normalsize Research position in experimental particle physics as part of the \lhcb collaboration
...
{}{\normalsize A-levels: Physics (A), Mathematics (A), Chemistry (A), Further Mathematics (A). \\
GCSEs: 3 A*, 3 A, 3 B.}
...
\cvitem{Professional}{
Delivered multiple high profile results for \lhcb, working over timescales ranging from a few months to several years.  
...
Convenor of a working group for \lhcb, coordinating research projects Europe-wide as well as leading research project teams and supervising both undergraduate and postgraduate students.
...
\cvitem{Software}{Designed, implemented and maintained software across the \lhcb collaboration, in Python and C++, at both user-level and for production systems 
with hundreds of users.
The quality of the data-taking software is a critical to record high value data and the output of this is used by the entire collaboration.
